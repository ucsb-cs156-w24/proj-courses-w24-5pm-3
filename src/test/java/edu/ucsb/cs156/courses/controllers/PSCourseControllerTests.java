...
public class PSCourseControllerTests extends ControllerTestCase {
  ...
  public void api_courses_admin_all__logged_out__returns_403() throws Exception {
    mockMvc.perform(get("/api/courses/admin/all")).andExpect(status().is(403));
  }
  ...
  public void api_courses_admin__user_logged_in__returns_403() throws Exception {
    mockMvc.perform(get("/api/courses/admin?id=7")).andExpect(status().is(403));
  }

  @WithMockUser(roles = {"ADMIN"})
  @Test
  public void api_courses_admin_all__admin_logged_in__returns_200() throws Exception {
    mockMvc.perform(get("/api/courses/admin/all")).andExpect(status().isOk());
  }
  ...
  public void api_courses_all__user_logged_in__returns_200() throws Exception {
    mockMvc.perform(get("/api/courses/user/all")).andExpect(status().isOk());
  }
  ...
  public void api_courses_post__logged_out__returns_403() throws Exception {
    mockMvc.perform(post("/api/courses/post")).andExpect(status().is(403));
  }
  ...
  public void api_courses__user_logged_in__returns_a_courses_that_exists() throws Exception {
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/courses/user?id=7")).andExpect(status().isOk()).andReturn();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses__user_logged_in__search_for_courses_that_does_not_exist()
      throws Exception {
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/courses/user?id=7")).andExpect(status().isNotFound()).andReturn();
  ...
  public void api_courses__admin_logged_in__returns_a_courses_that_exists_using_psid()
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/courses/admin/psid/all?psId=13"))
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses__user_logged_in__returns_a_courses_that_exists_using_psid()
      throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/courses/user/psid/all?psId=13"))
            .andExpect(status().isOk())
            .andReturn();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses__user_logged_in__search_for_courses_that_belongs_to_another_user()
      throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/courses/user?id=13"))
  ...
  @Test
  public void api_courses__admin_logged_in__search_for_course_that_belongs_to_another_user()
      throws Exception {
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/courses/admin?id=27")).andExpect(status().isOk()).andReturn();
  ...
  @WithMockUser(roles = {"ADMIN", "USER"})
  @Test
  public void api_courses__admin_logged_in__search_for_course_that_does_not_exist()
      throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/courses/admin?id=29"))
            .andExpect(status().isNotFound())
            .andReturn();
  ...
  public void api_courses_admin_all__admin_logged_in__returns_all_courses() throws Exception {
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/courses/admin/all")).andExpect(status().isOk()).andReturn();
  ...
  public void api_courses_post__user_logged_in__primary_enroll_code() throws Exception {
    ...
    PersonalSchedule personalschedule1 =
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses_post__user_logged_in__primary_enroll_code_already_exists()
      throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
  ...
  public void api_courses_post__user_logged_in__primary_enroll_code_has_one_secondary()
    ...
    Map<String, Object> json = responseToJson(response);
    assertEquals(
        "63370 is for a course with sections; please add a specific section and the lecture will be automatically added",
        json.get("message"));
    assertEquals("IllegalArgumentException", json.get("type"));
  }
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses_post__user_logged_in__primary_enroll_code_has_one_secondary_reversed()
      throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    ...
    when(personalScheduleRepository.findByIdAndUser(eq(1L), eq(u)))
        .thenReturn(Optional.of(personalschedule1));
    when(ucsbCurriculumService.getAllSections(eq("63370"), eq("20221")))
        .thenReturn(SectionFixtures.SECTION_JSON_CMPSC100_REVERSED);
    when(coursesRepository.findByPsIdAndEnrollCd(eq(1L), eq("63370"))).thenReturn(Optional.empty());
  ...
  @Test
  public void
      api_courses_post__user_logged_in__unexpected_ucsb_api_response_assumes_primary_course()
          throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses_post__user_logged_in__secondary_enroll_code_adds_secondary_and_primary()
      throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses_post__user_logged_in__section_order_in_json_does_not_matter()
      throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses_post__user_logged_in__post_course_from_spring() throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();

    /*-----------------------TEST FOR SPRING QUARTER-----------------------*/
    PersonalSchedule personalschedule1 =
        PersonalSchedule.builder()
            .name("Test")
            .description("Test")
    ...
    when(personalScheduleRepository.findByIdAndUser(eq(1L), eq(u)))
        .thenReturn(Optional.of(personalschedule1));
    when(ucsbCurriculumService.getAllSections(eq("08896"), eq("20222")))
        .thenReturn(SectionFixtures.SECTION_JSON_CMPSC291A_UNEXPECTED);

    PSCourse expectedSpring =
        PSCourse.builder()
            .enrollCd("08896")
            .psId(1L)
            .psName("Test")
            ...
            .id(0L)
            .build();
    when(coursesRepository.save(eq(expectedSpring))).thenReturn(expectedSpring);
    when(coursesRepository.findByPsIdAndEnrollCd(eq(1L), eq("08896"))).thenReturn(Optional.empty());

    ArrayList<PSCourse> expectedCoursesSpring = new ArrayList<>();
    expectedCoursesSpring.add(expectedSpring);
    ...
    // assert
    verify(coursesRepository, times(1)).save(expectedSpring);
    String expectedJson = mapper.writeValueAsString(expectedCoursesSpring);
    String responseString = response.getResponse().getContentAsString();
    assertEquals(expectedJson, responseString);
  }
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses_post__user_logged_in__post_course_from_summer() throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    ...
    when(personalScheduleRepository.findByIdAndUser(eq(1L), eq(u)))
        .thenReturn(Optional.of(personalschedule1));
    when(ucsbCurriculumService.getAllSections(eq("08896"), eq("20223")))
        .thenReturn(SectionFixtures.SECTION_JSON_CMPSC291A_UNEXPECTED);

    PSCourse expectedSummer =
        PSCourse.builder()
            .enrollCd("08896")
            .psId(1L)
            .psName("Test")
            ...
            .id(0L)
            .build();
    when(coursesRepository.save(eq(expectedSummer))).thenReturn(expectedSummer);
    when(coursesRepository.findByPsIdAndEnrollCd(eq(1L), eq("08896"))).thenReturn(Optional.empty());

    ArrayList<PSCourse> expectedCoursesSummer = new ArrayList<>();
    expectedCoursesSummer.add(expectedSummer);
    ...
    // assert
    verify(coursesRepository, times(1)).save(expectedSummer);
    String expectedJson = mapper.writeValueAsString(expectedCoursesSummer);
    String responseString = response.getResponse().getContentAsString();
    assertEquals(expectedJson, responseString);
  }
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses_post__user_logged_in__post_course_from_fall() throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    ...
    when(personalScheduleRepository.findByIdAndUser(eq(1L), eq(u)))
        .thenReturn(Optional.of(personalschedule1));
    when(ucsbCurriculumService.getAllSections(eq("08896"), eq("20224")))
        .thenReturn(SectionFixtures.SECTION_JSON_CMPSC291A_UNEXPECTED);

    PSCourse expectedFall =
        PSCourse.builder()
            .enrollCd("08896")
            .psId(1L)
            .psName("Test")
            ...
            .id(0L)
            .build();
    when(coursesRepository.save(eq(expectedFall))).thenReturn(expectedFall);
    when(coursesRepository.findByPsIdAndEnrollCd(eq(1L), eq("08896"))).thenReturn(Optional.empty());

    ArrayList<PSCourse> expectedCoursesFall = new ArrayList<>();
    expectedCoursesFall.add(expectedFall);
    ...
    // assert
    verify(coursesRepository, times(1)).save(expectedFall);
    String expectedJson = mapper.writeValueAsString(expectedCoursesFall);
    String responseString = response.getResponse().getContentAsString();
    assertEquals(expectedJson, responseString);
  }
  ...
  public void apiCoursesUserCreatesCourseWithInvalidEnrollCd() throws Exception {
    ...
    when(ucsbCurriculumService.getAllSections(eq("test"), eq("20224")))
    ...
    Map<String, Object> json = responseToJson(response);
    assertEquals(
        "EnrollCd: test is invalid, (enrollCd must be valid, numeric, and no more than five digits)",
        json.get("message"));
  ...
  @Test
  public void
      api_courses__user_logged_in__delete_course__ucsb_api__enroll_code_does_not_exist_error__treat_as_primary()
          throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    PersonalSchedule ps =
    ...
    PSCourse primary1 = PSCourse.builder().enrollCd("11111").psId(2L).user(u).id(2L).build();
    ...
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("11111")))
        .thenReturn(Optional.of(primary1));
    when(personalScheduleRepository.findByIdAndUser(eq(2L), eq(u))).thenReturn(Optional.of(ps1));
    when(ucsbCurriculumService.getAllSections(eq("11111"), eq("20221")))
        .thenReturn("{\"error\": \"Enroll code doesn't exist in that quarter.\"}");

    // act
    MvcResult response =
        mockMvc
            .perform(delete("/api/courses/user?id=1").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    MvcResult response1 =
        mockMvc
            .perform(
                delete("/api/courses/user/deleteByPsIdAndEnrollCd?psId=2&enrollCd=11111")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    verify(coursesRepository, times(1)).findByPsIdAndEnrollCd(2L, "11111");
    verify(coursesRepository, times(1)).delete(primary1);
    Map<String, Object> json1 = responseToJson(response1);
    assertEquals("PSCourse with id 2 deleted", json1.get("message"));
  }

  @WithMockUser(roles = {"USER"})
  @Test
  public void
      api_courses__user_logged_in__delete_course__ucsb_api__unauthorized_error__treat_as_primary()
          throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    PersonalSchedule ps =
  ...
  @Test
  public void
      api_courses__user_logged_in__delete_course__ucsb_api__primary_not_found__treat_as_primary()
          throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    PersonalSchedule ps =
    ...
    PersonalSchedule ps1 =
        PersonalSchedule.builder()
            ...
            .build();
    PSCourse primary = PSCourse.builder().enrollCd("08896").psId(1L).user(u).id(1L).build();
    PSCourse primary1 = PSCourse.builder().enrollCd("08300").psId(2L).user(u).id(2L).build();
    ...
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("08300")))
        .thenReturn(Optional.of(primary1));
    when(personalScheduleRepository.findByIdAndUser(eq(2L), eq(u))).thenReturn(Optional.of(ps1));
    when(ucsbCurriculumService.getAllSections(eq("08300"), eq("20221")))
        .thenReturn(SectionFixtures.SECTION_JSON_CMPSC156_UNEXPECTED);
    ...
    MvcResult response1 =
        mockMvc
            .perform(
                delete("/api/courses/user/deleteByPsIdAndEnrollCd?psId=2&enrollCd=08300")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    verify(coursesRepository, times(2)).findByPsIdAndEnrollCd(2L, "08300");
    verify(coursesRepository, times(1)).delete(primary1);
    Map<String, Object> json1 = responseToJson(response1);
    assertEquals("PSCourse with id 2 deleted", json1.get("message"));
  }
  ...
  public void api_courses__user_logged_in__delete_course__primary_with_no_secondary()
    ...
    PersonalSchedule ps1 =
        PersonalSchedule.builder()
            ...
            .build();
    PSCourse primary = PSCourse.builder().enrollCd("08896").psId(1L).user(u).id(1L).build();
    PSCourse primary1 = PSCourse.builder().enrollCd("08896").psId(2L).user(u).id(2L).build();
    ...
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("08896")))
        .thenReturn(Optional.of(primary1));
    when(personalScheduleRepository.findByIdAndUser(eq(2L), eq(u))).thenReturn(Optional.of(ps1));
    when(ucsbCurriculumService.getAllSections(eq("08896"), eq("20221")))
        .thenReturn(SectionFixtures.SECTION_JSON_CMPSC291A);
    ...
    MvcResult response1 =
        mockMvc
            .perform(
                delete("/api/courses/user/deleteByPsIdAndEnrollCd?psId=2&enrollCd=08896")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    verify(coursesRepository, times(2)).findByPsIdAndEnrollCd(2L, "08896");
    verify(coursesRepository, times(1)).delete(primary1);
    Map<String, Object> json1 = responseToJson(response1);
    assertEquals("PSCourse with id 2 deleted", json1.get("message"));
  }
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses__user_logged_in__delete_course__primary_with_secondary()
      throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    PersonalSchedule ps =
    ...
    PSCourse primary1 = PSCourse.builder().enrollCd("63370").psId(2L).user(u).id(3L).build();
    PSCourse secondary1 = PSCourse.builder().enrollCd("63388").psId(2L).user(u).id(4L).build();
    ...
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("63370")))
        .thenReturn(Optional.of(primary1));
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("63388")))
        .thenReturn(Optional.of(secondary1));
    when(personalScheduleRepository.findByIdAndUser(eq(2L), eq(u))).thenReturn(Optional.of(ps1));
    when(ucsbCurriculumService.getAllSections(eq("63370"), eq("20221")))
        .thenReturn(SectionFixtures.SECTION_JSON_CMPSC100);
    ...
    MvcResult response1 =
        mockMvc
            .perform(
                delete("/api/courses/user/deleteByPsIdAndEnrollCd?psId=2&enrollCd=63370")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    verify(coursesRepository, times(1)).findByIdAndUser(1L, u);
    verify(personalScheduleRepository, times(1)).findByIdAndUser(1L, u);
    verify(ucsbCurriculumService, times(2)).getAllSections("63370", "20221");
    verify(coursesRepository, times(1)).delete(primary);
    ...
    verify(coursesRepository, times(2)).findByPsIdAndEnrollCd(2L, "63370");
    verify(coursesRepository, times(1)).findByPsIdAndEnrollCd(2L, "63388");
    verify(personalScheduleRepository, times(1)).findByIdAndUser(2L, u);
    verify(coursesRepository, times(1)).delete(primary);
    verify(coursesRepository, times(1)).delete(secondary);
    Map<String, Object> json1 = responseToJson(response1);
    assertEquals(
        "PSCourse with id 3 and matching secondary with id 4 deleted", json1.get("message"));
  }
  ...
  public void api_courses__user_logged_in__delete_course__secondary_with_primary()
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/courses/user?id=2").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    MvcResult response1 =
        mockMvc
            .perform(
                delete("/api/courses/user/deleteByPsIdAndEnrollCd?psId=2&enrollCd=63388")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    verify(personalScheduleRepository, times(1)).findByIdAndUser(1L, u);
    verify(ucsbCurriculumService, times(2)).getAllSections("63388", "20221");
    verify(coursesRepository, times(1)).delete(primary);
    verify(coursesRepository, times(1)).delete(secondary);
    Map<String, Object> json = responseToJson(response);
    assertEquals("PSCourse with id 2 and matching primary with id 1 deleted", json.get("message"));

    verify(coursesRepository, times(2)).findByPsIdAndEnrollCd(2L, "63388");
    verify(coursesRepository, times(1)).findByPsIdAndEnrollCd(2L, "63370");
    verify(personalScheduleRepository, times(1)).findByIdAndUser(2L, u);
    verify(coursesRepository, times(1)).delete(primary1);
    verify(coursesRepository, times(1)).delete(secondary1);
    Map<String, Object> json1 = responseToJson(response1);
    assertEquals("PSCourse with id 4 and matching primary with id 3 deleted", json1.get("message"));
  }

  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses__user_logged_in__delete_course__primary_with_multiple_secondaries()
      throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    PersonalSchedule ps =
    ...
    PSCourse primary1 = PSCourse.builder().enrollCd("08292").psId(2L).user(u).id(3L).build();
    PSCourse secondary1 = PSCourse.builder().enrollCd("08300").psId(2L).user(u).id(4L).build();
    ...
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("08292")))
        .thenReturn(Optional.of(primary1));
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("08300")))
        .thenReturn(Optional.of(secondary1));
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("08318"))).thenReturn(Optional.empty());
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("08326"))).thenReturn(Optional.empty());
    when(personalScheduleRepository.findByIdAndUser(eq(2L), eq(u))).thenReturn(Optional.of(ps1));
    when(ucsbCurriculumService.getAllSections(eq("08292"), eq("20221")))
        .thenReturn(SectionFixtures.SECTION_JSON_CMPSC156_UNEXPECTED);
    ...
    MvcResult response1 =
        mockMvc
            .perform(
                delete("/api/courses/user/deleteByPsIdAndEnrollCd?psId=2&enrollCd=08292")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    verify(coursesRepository, times(1)).findByIdAndUser(1L, u);
    verify(personalScheduleRepository, times(1)).findByIdAndUser(1L, u);
    verify(ucsbCurriculumService, times(2)).getAllSections("08292", "20221");
    verify(coursesRepository, times(1)).delete(primary);
    verify(coursesRepository, times(1)).delete(secondary);
    Map<String, Object> json = responseToJson(response);
    assertEquals(
    ...
    verify(coursesRepository, times(2)).findByPsIdAndEnrollCd(2L, "08292");
    verify(coursesRepository, times(1)).findByPsIdAndEnrollCd(2L, "08300");
    verify(personalScheduleRepository, times(1)).findByIdAndUser(2L, u);
    verify(coursesRepository, times(1)).delete(primary1);
    verify(coursesRepository, times(1)).delete(secondary1);
    Map<String, Object> json1 = responseToJson(response1);
  ...
  public void api_courses__user_logged_in__delete_course_that_does_not_exist() throws Exception {
    ...
    when(coursesRepository.findByPsIdAndEnrollCd(eq(2L), eq("12345"))).thenReturn(Optional.empty());
    ...
    MvcResult response1 =
        mockMvc
            .perform(
                delete("/api/courses/user/deleteByPsIdAndEnrollCd?psId=2&enrollCd=12345")
                    .with(csrf()))
            .andExpect(status().isNotFound())
            .andReturn();
    ...
    verify(coursesRepository, times(1)).findByPsIdAndEnrollCd(2, "12345");
    Map<String, Object> json1 = responseToJson(response1);
    assertEquals("PSCourse with id 2 not found", json1.get("message"));
  }

  @WithMockUser(roles = {"USER"})
  @Test
  public void
      api_courses__user_logged_in__delete_course_with_personal_schedule_that_does_not_exist()
          throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    PSCourse course = PSCourse.builder().enrollCd("00000").psId(1L).user(u).id(1L).build();
    PSCourse course1 = PSCourse.builder().enrollCd("11111").psId(2L).user(u).id(2L).build();
    ...
    when(personalScheduleRepository.findByIdAndUser(eq(2L), eq(u))).thenReturn(Optional.empty());
    ...
    verify(personalScheduleRepository, times(1)).findByIdAndUser(2L, u);
    Map<String, Object> json1 = responseToJson(response1);
    assertEquals("PersonalSchedule with id 2 not found", json1.get("message"));
  }
  ...
  public void api_courses__user_logged_in__cannot_delete_delete_belonging_to_another_user()
    ...
    when(coursesRepository.findByPsIdAndEnrollCd(eq(31L), eq("08250")))
        .thenReturn(Optional.of(ps1));

    // act
    MvcResult response =
        mockMvc
            .perform(delete("/api/courses/user?id=31").with(csrf()))
            .andExpect(status().isNotFound())
            .andReturn();
    ...
    MvcResult response1 =
        mockMvc
            .perform(
                delete("/api/courses/user/deleteByPsIdAndEnrollCd?psId=13&enrollCd=08250")
                    .with(csrf()))
            .andExpect(status().isNotFound())
            .andReturn();
    ...
    Map<String, Object> json1 = responseToJson(response1);
    assertEquals("PSCourse with id 13 not found", json1.get("message"));
  }
  ...
  public void api_courses__admin_logged_in__delete_course() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/courses/admin?id=16").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  @WithMockUser(roles = {"ADMIN", "USER"})
  @Test
  public void api_courses__admin_logged_in__cannot_delete_course_that_does_not_exist()
      throws Exception {
    // arrange
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/courses/admin?id=17").with(csrf()))
            .andExpect(status().isNotFound())
            .andReturn();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_courses__user_logged_in__cannot_put_course_that_does_not_exist()
      throws Exception {
    // arrange
  ...
  @WithMockUser(roles = {"ADMIN", "USER"})
  @Test
  public void api_courses__admin_logged_in__cannot_put_course_that_does_not_exist()
      throws Exception {
    // arrange
