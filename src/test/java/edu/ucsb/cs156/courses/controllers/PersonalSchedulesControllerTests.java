...
public class PersonalSchedulesControllerTests extends ControllerTestCase {
  ...
  public void api_schedules_admin_all__logged_out__returns_403() throws Exception {
    mockMvc.perform(get("/api/personalschedules/admin/all")).andExpect(status().is(403));
  }
  ...
  public void api_schedules_admin__user_logged_in__returns_403() throws Exception {
    mockMvc.perform(get("/api/personalschedules/admin?id=7")).andExpect(status().is(403));
  }

  @WithMockUser(roles = {"ADMIN"})
  @Test
  public void api_schedules_admin_all__admin_logged_in__returns_200() throws Exception {
    mockMvc.perform(get("/api/personalschedules/admin/all")).andExpect(status().isOk());
  }
  ...
  public void api_schedules_all__logged_out__returns_403() throws Exception {
    mockMvc.perform(get("/api/personalschedules/all")).andExpect(status().is(403));
  }

  @WithMockUser(roles = {"USER"})
  @Test
  public void api_schedules_all__user_logged_in__returns_200() throws Exception {
    mockMvc.perform(get("/api/personalschedules/all")).andExpect(status().isOk());
  }
  ...
  public void api_schedules_post__logged_out__returns_403() throws Exception {
    mockMvc.perform(post("/api/personalschedules/post")).andExpect(status().is(403));
  }
  ...
  public void api_schedules__user_logged_in__returns_a_schedules_that_exists() throws Exception {
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/personalschedules?id=7")).andExpect(status().isOk()).andReturn();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_schedules__user_logged_in__search_for_schedules_that_does_not_exist()
      throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/personalschedules?id=7"))
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_schedules__user_logged_in__search_for_schedules_that_belongs_to_another_user()
      throws Exception {
    ...
    PersonalSchedule otherUsersPersonalschedule =
        PersonalSchedule.builder()
            .name("Name 1")
            .description("Description 1")
            .quarter("20221")
    ...
    when(personalscheduleRepository.findByIdAndUser(eq(13L), eq(otherUser)))
        .thenReturn(Optional.of(otherUsersPersonalschedule));

    // act
    MvcResult response =
        mockMvc
            .perform(get("/api/personalschedules?id=13"))
            .andExpect(status().isNotFound())
            .andReturn();
  ...
  @Test
  public void api_schedules__admin_logged_in__search_for_schedule_that_belongs_to_another_user()
      throws Exception {
    ...
    when(personalscheduleRepository.findById(eq(27L)))
        .thenReturn(Optional.of(otherUsersPersonalschedule));

    // act
    MvcResult response =
        mockMvc
            .perform(get("/api/personalschedules/admin?id=27"))
  ...
  @WithMockUser(roles = {"ADMIN", "USER"})
  @Test
  public void api_schedules__admin_logged_in__search_for_schedule_that_does_not_exist()
      throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/personalschedules/admin?id=29"))
            .andExpect(status().isNotFound())
            .andReturn();
  ...
  public void api_schedules_admin_all__admin_logged_in__returns_all_schedules() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/personalschedules/admin/all"))
            .andExpect(status().isOk())
            .andReturn();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_schedules_all__user_logged_in__returns_only_schedules_for_user()
      throws Exception {
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/personalschedules/all")).andExpect(status().isOk()).andReturn();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_schedules__user_logged_in__delete_schedule_that_does_not_exist()
      throws Exception {
    // arrange
    ...
    PersonalSchedule ps1 =
        PersonalSchedule.builder()
            ...
            .id(15L)
            .build();
    when(personalscheduleRepository.findByIdAndUser(eq(15L), eq(otherUser)))
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_schedules__user_logged_in__cannot_delete_delete_belonging_to_another_user()
      throws Exception {
    // arrange
    User u = currentUserService.getCurrentUser().getUser();
    User otherUser = User.builder().id(98L).build();
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/personalschedules?id=31").with(csrf()))
            .andExpect(status().isNotFound())
            .andReturn();
  ...
  public void api_schedules__admin_logged_in__delete_schedule() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/personalschedules/admin?id=16").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  @WithMockUser(roles = {"ADMIN", "USER"})
  @Test
  public void api_schedules__admin_logged_in__cannot_delete_schedule_that_does_not_exist()
      throws Exception {
    // arrange
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/personalschedules/admin?id=17").with(csrf()))
            .andExpect(status().isNotFound())
            .andReturn();
  ...
  public void api_schedules__user_logged_in__put_schedule() throws Exception {
    ...
    PersonalSchedule updatedSchedule =
        PersonalSchedule.builder()
            ...
            .id(67L)
            .build();
    PersonalSchedule correctSchedule =
        PersonalSchedule.builder()
            .name("Name 2")
            .description("Description 2")
            .quarter("20222")
    ...
    verify(personalscheduleRepository, times(1))
        .save(correctSchedule); // should be saved with correct user
    String responseString = response.getResponse().getContentAsString();
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_schedules__user_logged_in__cannot_put_schedule_that_does_not_exist()
      throws Exception {
    // arrange
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void api_schedules__user_logged_in__cannot_put_schedule_for_another_user()
      throws Exception {
    // arrange
    ...
    when(personalscheduleRepository.findByIdAndUser(eq(31L), eq(otherUser)))
        .thenReturn(Optional.of(ps1));
  ...
  @WithMockUser(roles = {"ADMIN", "USER"})
  @Test
  public void api_schedules__admin_logged_in__cannot_put_schedule_that_does_not_exist()
      throws Exception {
    // arrange
