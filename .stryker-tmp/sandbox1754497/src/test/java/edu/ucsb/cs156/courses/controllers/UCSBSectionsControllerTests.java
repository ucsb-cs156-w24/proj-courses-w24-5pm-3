...
public class UCSBSectionsControllerTests {
  ...
  public void test_search() throws Exception {
    ...
    when(ucsbCurriculumService.getSectionJSON(
            any(String.class), any(String.class), any(String.class)))
        .thenReturn(expectedResult);

    MvcResult response = mockMvc.perform(get(url).contentType("application/json")).andReturn();
  ...
  public void test_section_search() throws Exception {
    ...
    when(ucsbCurriculumService.getSection(any(String.class), any(String.class)))
        .thenReturn(expectedResult);
