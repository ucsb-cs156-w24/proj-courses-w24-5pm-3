...
6. Sync with repo (substitute your own team name):
   ```
   dokku git:sync courses https://github.com/ucsb-cs156-w24/courses-w24-5pm-3 main
   ```
...
3. Sync with repo (substitute your own team name and branch name):
   ```
   dokku git:sync https://github.com/ucsb-cs156-w24/courses-w24-5pm-3 courses-yourName your-branch-name
   ```
4. Build app:
   ```
